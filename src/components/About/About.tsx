        ...
        <div>
          ...
          <div style={{ margin: "1%" }}>
            <p>
              ...
              I also have a Blog you can check out, where I write about
              interesting tect and software I worked with. Lastly, feel free to
              check my git or linkedin pages, or send me an email. Links are
              bellow as well.
            </p>
          </div>
          <br></br>
